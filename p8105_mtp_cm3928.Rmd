...
hornlike_df %>% 
  ...
  labs(
    title = "Figure 1. EOP Size against its associated Group",
    x = "EOP Group",
    y = "EOP Size")
```
...
hornlike_df %>% 
  ...
  labs(
    title = "Figure 2. FHP Size against FHP Group",
    x = "FHP Group",
    y = "FHP Size")
```
