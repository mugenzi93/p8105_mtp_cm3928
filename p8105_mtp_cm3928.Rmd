...
I notice several issues in this figure. Here the categorical variable **eop_group** is misclassifying several **eop_size** values. For instance, in the range **20-25**, the eop size seems to span values ranging from 20 to about 35 mm.
...
The same pattern of misclassification is happening here as well where FHP sizes are being classified in groups they should not be classified in due to poor definitions of ranges on the part of the researcher.
...
There seems to be a positive association between EOP and FHP sizes for female subjects in the 18-30 age group but a steady pattern with few bumps in the remaining age groups. For males, there is an overall increasing pattern of EOP size as FHP size increases. 
...
In conclusion, my results confirm a high rate of EEOP in male subjects across all age groups and no significant association between EEOP and FHP size. Overall, the original report was consistent with the data provided but failed to confirm the association between FHP and EEOP. We cannot confirm that the use of smart devices is associated with EEOP/horn growth since there is no predictor detailing the time spent on smart devices and what population groups tend to use these devices more. Therefore, time spent on smart devices will further help us reach a more telling conclusion.  
