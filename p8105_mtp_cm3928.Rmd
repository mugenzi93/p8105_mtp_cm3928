...
This dataset is comprised of **`r ncol(hornlike_df)`** variables and **`r nrow(hornlike_df)`** observations which is also the number representative of how many participants were studied by the original scientific report. The orginal dataset had 9 variables but I eliminated the shape variable for the purpose of this assignment.  
