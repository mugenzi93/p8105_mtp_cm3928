...
**eop\_group** is misclassifying several **eop\_size** values. For
instance, in the range **20-25**, the eop size seems to span values
ranging from 20 to about 35 mm.
...
in due to poor definitions of ranges on the part of the researcher.
...
increasing pattern of EOP size as FHP size increases.

# Reproducing Results

The research’s sample size of 1200 is inconsistent with my sample size
of **1221.**
...
In conclusion, my results confirm a high rate of EEOP in male subjects
...
provided but failed to confirm the association between FHP and EEOP. We
...
smart devices and what population groups tend to use these devices more.
Therefore, time spent on smart devices will further help us reach a more
telling conclusion.
