...
enlarged “hornlike” spike mostly found in millenial’s skulls.
...
female subjects in the 18-30 age group but overall steady pattern with
few bumps in the remaining age groups. For males, there is an overall
increased pattern of EOP size as FHP size increases.
...
A subject is said to have **Enlarged Occipital Protuberance (EEOP) only
when the EOP exceeds **10 mm\*\* in size, where EOP size is the key
...
My **57.6%** of FHP size greater than **40 mm** is not constistent with
this study’s **34.5%.**
